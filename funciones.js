...
export function listaPrestamos() {
    ...
    arrayPrestamos.forEach( arrayPrestamos => {
        const li = document.createElement('li');
        li.innerText = arrayPrestamos;
...
export function imgPrestamos() {
    ...
    const imagenPrestamos = document.createElement('img');
    imagenPrestamos.className = "img-fluid";
    imagenPrestamos.src = "prestamosbiblio.jpg";
    return imagenPrestamos;
}
...
export function listaSocios() {
    ...
    arraySocios.forEach( arraySocios => {
        const li = document.createElement('li');
        li.innerText = arraySocios;
        li.className = "list-group-item";
        ul.appendChild(li);
    } );
    return ul;
...
export function imgSocios() {
    // devuelve la imagen de socios
    const imagenSocios = document.createElement('img');
    imagenSocios.className = "img-fluid";
    imagenSocios.src = "prestamosbiblio.jpg";
    return imagenSocios;
}
